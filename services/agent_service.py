...
class AgentService:
    ...
    def _setup_adk_components(self):
        ...
        try:
            ...
            # Setup session service - using database instead of Supabase
            ...
            # Alternative: Use DatabaseSessionService
    ...
    async def create_session(self, user_profile: UserProfile, metadata: Dict[str, Any] = None) -> str:
        ...
        try:
            ...
            self.logger.error("Failed to create session", error=str(e), user_id=user_profile.id)
    ...
    async def process_user_query(
        ...
        try:
            if self.runner and ADK_AVAILABLE:
                return await self._process_with_adk(user_profile, session_id, user_message)
            else:
    ...
    # Fallback methods (your existing implementation)
    ...
    async def _process_with_fallback(self, user_profile: UserProfile, session_id: str, user_message: str) -> str:
        ...
        risk_detected = any(keyword in message_lower for keyword in risk_keywords)
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        if self.runner:
            health_status["adk_runner"] = "initialized"
        else:
            health_status["adk_runner"] = "not_available"
